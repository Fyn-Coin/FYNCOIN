...
RESOURCES += src/qt/fyncoin.qrc src/qt/fyncoin_locale.qrc

TRANSLATIONS += src/qt/locale/fyncoin_bg.ts \
                src/qt/locale/fyncoin_de.ts \
                src/qt/locale/fyncoin_en.ts \
                src/qt/locale/fyncoin_es.ts \
                src/qt/locale/fyncoin_fi.ts \
                src/qt/locale/fyncoin_fr.ts \
                src/qt/locale/fyncoin_it.ts \
                src/qt/locale/fyncoin_ja.ts \
                src/qt/locale/fyncoin_pl.ts \
                src/qt/locale/fyncoin_pt.ts \
                src/qt/locale/fyncoin_ru.ts \
                src/qt/locale/fyncoin_sk.ts \
                src/qt/locale/fyncoin_sv.ts \
                src/qt/locale/fyncoin_vi.ts \
                src/qt/locale/fyncoin_zh_CN.ts \
                src/qt/locale/fyncoin_zh_TW.ts
