...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Fyn Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Fyn Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fyn Coin features */
        {"fyncoin", "masternode", &masternode, true, true, false},
        {"fyncoin", "listmasternodes", &listmasternodes, true, true, false},
        {"fyncoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fyncoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fyncoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fyncoin", "masternodedebug", &masternodedebug, true, true, false},
        {"fyncoin", "startmasternode", &startmasternode, true, true, false},
        {"fyncoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fyncoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fyncoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fyncoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fyncoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fyncoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fyncoin", "mnbudget", &mnbudget, true, true, false},
        {"fyncoin", "preparebudget", &preparebudget, true, true, false},
        {"fyncoin", "submitbudget", &submitbudget, true, true, false},
        {"fyncoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fyncoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fyncoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fyncoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fyncoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fyncoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fyncoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fyncoin", "checkbudgets", &checkbudgets, true, true, false},
        {"fyncoin", "mnsync", &mnsync, true, true, false},
        {"fyncoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> fyncoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19332/\n";
}
