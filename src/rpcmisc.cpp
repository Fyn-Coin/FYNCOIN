...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"fynaddress\"\n"
            "\nReturn information about the given fyn address.\n"
            "\nArguments:\n"
            "1. \"fynaddress\"     (string, required) The fyn address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"fynaddress\", (string) The fyn address validated\n"
