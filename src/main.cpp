...
#if defined(NDEBUG)
#error "Fyn Coin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ufyn) are considered zero fee (for relaying and mining)
