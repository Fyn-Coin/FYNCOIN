                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Fyn Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fyncoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fyn Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fyn Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fyn Coin"));
    ...
    openAction->setStatusTip(tr("Open a fyncoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fyn Coin Core help message to get a list with possible Fyn Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Fyn Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fyn Coin network", "", count));
}
...
{
    QString strTitle = tr("Fyn Coin Core"); // default title
