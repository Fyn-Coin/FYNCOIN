...
#   c) node1 mines 32 blocks, so now node 0 has 500000FYN, node 1 has 4250FYN, node2 has none.
#   d) node0 sends 601 FYN to node2, in two transactions (301 FYN, then 300 FYN).
