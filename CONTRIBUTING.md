Contributing to Fyn Coin Core
==================================

The Fyn Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Fyn Coin Core project, and is not to be
confused with overall Fyn Coin Network Protocol consensus changes.

Whether a pull request is merged into Fyn Coin Core rests with the project merge
...
Patches that change Fyn Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fyn Coin consensus, it must have been
...
The project leader is the release manager for each Fyn Coin Core release.
