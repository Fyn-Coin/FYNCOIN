...
Intro
-----
Fyn Coin (FYN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Fyn Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run fyncoin-qt.exe.

Fyn Coin Core is the original Fyn Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Fyn Coin transactions;
