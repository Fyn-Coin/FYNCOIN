...
In order to support loading of multiple wallets in fyncoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fyncoin.cpp.
...
Changes to fyncoin.cpp
----------------------
fyncoin.cpp is the entry point into fyncoin-qt, and as such, will require some minor modifications to provide hooks for
