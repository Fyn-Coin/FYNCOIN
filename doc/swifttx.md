...
This mechanism has been integrated into Bitcore-Node-FynCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fyncoin/insight-api-fyncoin#web-socket-api](https://github.com/fyncoin/insight-api-fyncoin#web-socket-api)
* API: [https://github.com/fyncoin/insight-api-fyncoin#swifttx-transactions](https://github.com/fyncoin/insight-api-fyncoin#swifttx-transactions)
...
By default, the Fyn Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Fyn Coin Core daemon:
