...
Fyn Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fyncoin_address\> \<monthly_payment_fyncoin\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fyncoin_address\> \<monthly_payment_fyncoin\> \<collateral_hash\>
 ...
 * vote-many          - Vote on a Fyn Coin initiative
 * vote-alias         - Vote on a Fyn Coin initiative
 * vote               - Vote on a Fyn Coin initiative/budget
